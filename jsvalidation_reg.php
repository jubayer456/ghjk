	   	 ...
	   	 if ($emailErr == "" && $usernameErr == "" && $passwordErr == "" && $confirmpasswordErr == "") 
	   	 {
	   	 	...
	   	 	else
	   	 	{
...

	   	 		{
	   	 			...
	   	 			header("location: jsvalidation_login.php");
...
<html>
<head>
	<title>JAVASCRIPT VALIDATION FOR Registration FORM</title>
...
<body>
	...
	<div class="signup-input">
		<h1>Registration Now</h1>
         ...
         <p>Already Have Account? <a href="jsvalidation_login.php">Log In</a></p>
     </div>
